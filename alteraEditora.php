...
<form action="updateEditora.php" name="frmEditora" method="post" id="formulario" >
    <div class="box"> 
        <h1>Altera Editora</h1>
        <label>
			<input type="hidden" name="id" value="<?php echo $rows['id']; ?>" />
            <span>Nome</span>
            <input type="text" class="input_text" name="nome" id="nome" value="<?php echo $rows['nome']; ?>">
